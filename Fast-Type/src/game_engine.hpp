...
class game_engine {
    ...
    // maximum id that FastType will detect, in other words, FastType will only look
    ...
    // Game logic
    // calculates and controls logical behaviors of FastType
